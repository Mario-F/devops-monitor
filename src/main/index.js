...
import createWindow from '../common/createWindow'
...
// Save userData in separate folders for development.
if (isDevelopment) {
  // Set console loglevel to silly
  log.transports.console.level = 'silly'

  // Attach to electron app so this infomation is globally available
